  ...
  <SectionA>
    ...
    <HomeCardStyles>
      <HomeCards image={require("../assets/buy.png")}>
        ...
        <p>
          Find every home on the market,get your home's value value,book
          showings and even make offers all here on our website
        </p>
      </HomeCards>
      ...
      <HomeCards image={require("../assets/track.png")}>
        ...
        <p>
          stay in loop with weekly updates and 24/7 access to timeline of all
          the details of your transaction and your moves
        </p>
      </HomeCards>
      ...
      <HomeCards image={require("../assets/moving.png")}>
        ...
        <p>
          Buy, sell or Reny with us and get a moving concierge to coordinate
          everything from changing over your utilities , finding movers.
        </p>
      </HomeCards>
