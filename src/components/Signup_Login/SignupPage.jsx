...
export default class SignupPage extends Component {
  ...
  constructor() {
    ...
    this.handleContextApi = this.handleContextApi.bind(this);
  ...
  async LogIn(e) {
    ...
    const res = await Axios.post(
      "http://localhost/realestate-backend/index.php",
      {
        api: "user",
        action: "signin",
    ...
    if (res) {
      if (res.data.status_code != 500) {
        this.handleContextApi(res.data);
      } else {
        alert("Email or Password or incorrect");
      }
    }
    if (!res) {
      alert("network error");
  ...
  handleSubmit(e) {
    ...
    if (!this.state.userType) {
      return this.setState({ error: "* please select user type" });
    }
    Axios.post("http://localhost/realestate-backend/index.php", {
      api: "user",
      action: "signup",
        ...
        <FormGrid>
          <div className="left">
            <Form onSubmit={this.handleSubmit}>
              <h4>Sign Up</h4>
              {this.state.error && (
                <h5 onClick={this.dismissError}>{this.state.error}</h5>
              )}
              <div className="sign">
              ...
              <div className="signs">
                ...
                <select name="cars" onChange={(e) => this.handleUserType(e)}>
